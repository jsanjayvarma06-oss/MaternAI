"""
Engine 4 — Recovery & Wellbeing Tracker
Scores sleep, activity, and hormonal wellbeing (0-100 each, higher = more concern).
"""
...
def check_milestone(day_post_delivery: int) -> str | None:
    milestones = {
